...
#define Axis_Z_UpLim_Sensor						PEin(3)//ZÖáÉÏÏŞÎ»¼«ÏŞÎ»£¬Èç´¥·¢Ôò½øÈëÒì³£Çé¿ö£¬ÏòÉÏÎ»»ú±¨¾¯
...
#define X_Acc_Time_H	1500//¸ßËÙÄ£Ê½¼ÓËÙÊ±¼ä
...
//¸ßËÙ
#define X_SPEED_FREQ_H  				1900   //¸ßËÙÆµÂÊ 
...
//¸ßËÙ
#define Z_SPEED_FREQ_H  				1100  	//¸ßËÙÆµÂÊ  
...
//¸ßËÙ
#define Y_SPEED_FREQ  				700   	//¸ßËÙÆµÂÊ 
