...
// 	u32 Period_status;
    ...
    if(Axis_X.InCtrl_Flag == 2) //高速模式
    {
      ...
      else if(Axis_X.SpeedChange_Stage == 2)
      {
        if(Axis_X.NowACC > 0)
        {
      ...
      /*********匀速阶段*******/
      else if(Axis_X.SpeedChange_Stage == 3)
      {
      ...
      else if(Axis_X.SpeedChange_Stage == 4)
      {
      ...
      else if(Axis_X.SpeedChange_Stage == 5)
      {
    ...
    if(Axis_Z.InCtrl_Flag == 2) //高速模式
    {
      ...
      /*********减加速阶段*******/
      //公式 V3=V2+a(t-t1)-1/2h(t-t2)^2
      else if(Axis_Z.SpeedChange_Stage == 2)
      {
      ...
      /*********匀速阶段*******/
      else if(Axis_Z.SpeedChange_Stage == 3)
      {
      ...
      /*********加减速阶段*******/
      //公式 V5=V4-1/2h(t-t4)^2
      else if(Axis_Z.SpeedChange_Stage == 4)
      {
      ...
      /*********加减速阶段*******/
      //公式 V7=V6-a(t-t6)+1/2*h(t-t6)^2
      else if(Axis_Z.SpeedChange_Stage == 5)
      {
    ...
    else if(Axis_Z.InCtrl_Flag == 1)//工程师模式调节
    {
      Axis_Z.Target_Fre = 50+50*Action.Speed_Grade;
			Axis_Z.Target_Pulse = 5+10*Action.Step_Grade;
		...
		if(Axis_Y.InCtrl_Flag == 2) //高速模式
    {
      ...
      if(status > 999 && status < 63157)	//频率在95~6006HZ之间 63157
      {
		...
		{
			Axis_Y.Target_Fre = 50+50*Action.Speed_Grade;
			Axis_Y.Target_Pulse = 20+10*Action.Step_Grade;
